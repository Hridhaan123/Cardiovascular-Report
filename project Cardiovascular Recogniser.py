# -*- coding: utf-8 -*-
"""
Created on Tue Sep  6 17:21:38 2022
...
Question1 = Label(root, text = "Do you have chest discomfort?")
Question1.pack()
...
Question2 = Label(root, text = "Is your body noticing shortness of breath?")
Question2.pack()
...
Question3 = Label(root, text = "Are there any symtoms of neck pain?")
Question3.pack()
...
btn = Button(root, text = "Show Results", command = cardiovascular_score)
btn.pack()
